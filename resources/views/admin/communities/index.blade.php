...
@section('title', 'Supervised Communities')
                ...
                <tbody>
                    @forelse($communities as $community)
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="p-3 text-gray-600">{{ $community->subscriber_count }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="p-4 text-center text-gray-500">You are not supervising any communities yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
